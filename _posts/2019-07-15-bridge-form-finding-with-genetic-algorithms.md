...
{% include postimage.html name='expected_model.png' caption='Expected conceptual bridge model' %}
{% include postimage.html name='structural_bonding.png' caption='Structural bonds' %}
